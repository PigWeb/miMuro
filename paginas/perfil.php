		...
		<div id="container">
					...
					<div id="perfilmostrar">
							...
							<div id="infoperfil"><p>
								...
								<input type="submit" id="botonperfil" name="botonperfil" value="Seguir"></form>
								<form method="post" action="mensajes-privados.php" name="seguidores	"> <!-- nuevo!-->
								<input type="hidden" id="receptor" name="receptor" value="<?php echo $perf;?>"/><!-- nuevo!-->
								<input type="submit" id="botonperfil2" name="botonperfil" value="Enviar inbox"></form>
								<?php 								}		
									  					}	 
					  					else { 
					  						if($activo!=NULL){
					...
					<div id="mensajes">
						<div id="mensajestitulo">Muro</div>
									...
									if ($seguidores!=NULL){
										...
										<?php
											break;	
										 			...
										 			</br>La privacidad de este usuario no permite que envies ni que leas sus mensajes</div>';
